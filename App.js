  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.descricao}>
        ...
        é incrível e sempre me faz sentir em paz.
      </Text>
      <Button
title="Sair"
...
function Cantina({ navigation }) {
  return (
    <View style={styles.container2}>
      ...
      A cantina é um ambiente legal por ser um ponto de encontro para desfrutar de boa comida e socializar, oferecendo variedade gastronômica e uma atmosfera acolhedora.
      </Text>
      <Button
title="Sair"
onPress={() => navigation.navigate('Home')} />
...
function AreaVerde({ navigation }) {
  return (
    <View style={styles.container3}>
      ...
      A área verde é um ambiente legal por proporcionar contato direto com a natureza, promovendo relaxamento e bem-estar em meio a espaços naturais tranquilos e revitalizantes.
      </Text>
      <Button
title="Sair"
onPress={() => navigation.navigate('Home')} />
